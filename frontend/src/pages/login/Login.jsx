...
const Login = () => {
	...
	return (
		<div className='flex flex-col items-center justify-center min-w-[380px] sm:min-w-[420px] mx-auto page-transition relative z-10'>
			<div className='w-full p-8 rounded-3xl glass-panel border border-slate-700/60 transition-all duration-300'>
				<div className='text-center mb-6'>
					...
					<p className='text-xs text-slate-400'>Sign in to continue your real-time conversations</p>
				</div>
				...
				<form onSubmit={handleSubmit} className='space-y-4'>
					<div>
						...
						<input
							...
							className='w-full input bg-slate-800/60 border border-slate-700/80 rounded-xl h-11 text-slate-200 placeholder-slate-500 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all'
							value={username}
					...
					<div>
						...
						<div className='relative'>
							<input
								...
								placeholder='••••••••'
								className='w-full input bg-slate-800/60 border border-slate-700/80 rounded-xl h-11 text-slate-200 placeholder-slate-500 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all pr-11'
								value={password}
